...
const RECENT_INPUT_FILES = [
  'apps/desktop/src/renderer/src/components/MediaLibraryCreateModal.tsx',
  'apps/desktop/src/renderer/src/components/agentMetadata/AgentMetadataCollectorContext.tsx',
  'apps/desktop/src/renderer/src/pages/MediaLibrarySettingsDialogs.tsx',
