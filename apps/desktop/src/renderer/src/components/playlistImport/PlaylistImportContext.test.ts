...
const sourcePath = 'apps/desktop/src/renderer/src/components/playlistImport/PlaylistImportContext.tsx'
const identityReviewPath = 'apps/desktop/src/renderer/src/components/playlistImport/PlaylistImportIdentityReview.tsx'
const cssPath = 'apps/desktop/src/renderer/src/components/playlistImport/PlaylistImportContext.module.css'
...
describe('PlaylistImportProvider workspace', () => {
  ...
  it('broadcasts completion so recovered imports refresh mounted playlist surfaces', () => {
    const source = readFileSync(path.resolve(sourcePath), 'utf8')
    const listPage = readFileSync(path.resolve('apps/desktop/src/renderer/src/pages/PlaylistsPage.tsx'), 'utf8')
    const detailPage = readFileSync(path.resolve('apps/desktop/src/renderer/src/pages/PlaylistDetailPage.tsx'), 'utf8')
