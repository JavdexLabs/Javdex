...
const cssPath = 'apps/desktop/src/renderer/src/pages/MediaLibrarySettingsPage.module.css'
...
describe('MediaLibrarySettingsPage layout', () => {
  ...
  it('keeps compact library context above the old-style import workspace', () => {
    ...
    const component = readFileSync(
      path.resolve('apps/desktop/src/renderer/src/pages/MediaLibrarySettingsPage.tsx'),
      'utf8'
    )
    const tabs = readFileSync(
      path.resolve('apps/desktop/src/renderer/src/pages/MediaLibrarySettingsTabs.tsx'),
      'utf8'
    )
    const settingsPage = readFileSync(
      path.resolve('apps/desktop/src/renderer/src/pages/SettingsPage.tsx'),
      'utf8'
    )
