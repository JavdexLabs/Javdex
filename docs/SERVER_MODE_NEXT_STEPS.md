...
核对日期：2026-09-27。本轮正在准备 `0.8.0-beta.2`，以当前发布检验分支为准，进度见 [Beta 2 发布复核](reviews/beta2-release-audit-2026-09-27.md)。`0.8.0-beta.1` 已发布；下文 PR #115、0.7.1 和更早提交属于历史验收记录，不能代替本轮复验。
