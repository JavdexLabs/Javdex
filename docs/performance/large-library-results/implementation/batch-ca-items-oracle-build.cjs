...
const pendingRoutes = fs.readFileSync('apps/desktop/src/renderer/src/listView/pendingRoutes.ts', 'utf8')
...
const extracted = fs.readFileSync('packages/contracts/src/scanAuditView.ts','utf8')
...
const panel = fs.readFileSync('apps/desktop/src/renderer/src/components/settings/LibraryScanAuditPanel.tsx','utf8')
