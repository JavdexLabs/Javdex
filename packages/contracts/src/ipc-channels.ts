...
export const IPC = {
  ...
  MEDIA_LIBRARY_MOUNT_BROWSE: 'mediaLibrary:browseMount',
  ...
  MEDIA_LIBRARY_ROOT_REMOVE_PREVIEW: 'mediaLibrary:previewRootRemoval',
  ...
  THIS_COMPUTER_PROBE: 'thisComputer:probe',
  THIS_COMPUTER_RESTART: 'thisComputer:restart',
  THIS_COMPUTER_PICK_PLAYER: 'thisComputer:pickPlayer',
  THIS_COMPUTER_DETECT_PLAYER: 'thisComputer:detectPlayer',
  ...
  SCAN_AUDIT_HEADER: 'scan:auditHeader',
  SCAN_AUDIT_PAGE: 'scan:auditPage',
  SCAN_AUDIT_VIEW_PAGE: 'scan:auditViewPage',
  ...
  PENDING_AUDIT_PRESENCE: 'pendingAudit:presence',
  PENDING_SCAN_QUEUE_PAGE: 'pendingScanQueue:page',
  PENDING_SCAN_QUEUE_COUNT: 'pendingScanQueue:count',
  PENDING_SCAN_GET: 'pendingScan:get',
  PENDING_RESOURCE_IDENTITY_GET: 'pendingResourceIdentity:get',
  ...
  VIDEO_MANUAL_TAG_ADD_EXISTING: 'video:manualTagAddExisting',
  ...
  PLAYLIST_LIST_PAGE: 'playlist:listPage',
  PLAYLIST_GET: 'playlist:get',
  PLAYLIST_GET_PAGE: 'playlist:getPage',
  PLAYLIST_METADATA: 'playlist:metadata',
  PLAYLIST_VIDEO_PAGE: 'playlist:videoPage',
  ...
  ACTRESS_PICKER_PAGE: 'actress:pickerPage',
  ACTRESS_AVATAR_CROP_TARGETS: 'actress:avatarCropTargets',
  ACTRESS_AVATAR_CROP_COUNT: 'actress:avatarCropCount',
  ACTRESS_TEST_TARGET_PAGE: 'actress:testTargetPage',
  ACTRESS_TEST_TARGET_GET: 'actress:testTargetGet',
  ACTRESS_PICKER_GET: 'actress:pickerGet',
  ACTRESS_MERGE_CANDIDATES: 'actress:mergeCandidates',
  ACTRESS_FACE_SCAN_MANIFEST: 'actress:faceScanManifest',
  ACTRESS_GALLERY_PAGE: 'actress:galleryPage',
  ACTRESS_PROFILE: 'actress:profile',
  ACTRESS_METADATA: 'actress:metadata',
  ACTRESS_VIDEO_PAGE: 'actress:videoPage',
  ...
  ACTRESS_CONFLICT_QUEUE_PAGE: 'actressConflict:queuePage',
  ACTRESS_CONFLICT_GET: 'actressConflict:get',
  ...
  TAG_FILTER_OPTIONS: 'tag:filterOptions',
  TAG_MANUAL_OPTIONS: 'tag:manualOptions',
  ...
  CLASSIFICATION_IMAGE_PAGE: 'classificationImage:page',
  ...
  PENDING_VIDEO_SCRAPE_COUNT: 'pendingVideoScrape:count',
  PENDING_VIDEO_SCRAPE_EXISTING_IDS: 'pendingVideoScrape:existingIds',
  PENDING_VIDEO_SCRAPE_PAGE: 'pendingVideoScrape:page',
  PENDING_VIDEO_SCRAPE_GET: 'pendingVideoScrape:get',
  ...
  AVATAR_AUTO_CROP_BATCH_TARGETS: 'avatarAutoCropBatch:targets',
