...
export function createMediaLibraryServiceDependencies(
  overrides: Partial<MediaLibraryServiceDependencies> &
    Pick<MediaLibraryServiceDependencies, 'isVideoScraperRunnable'>
): MediaLibraryServiceDependencies {
  return {
