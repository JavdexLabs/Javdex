...
import { statFileFingerprint } from './scanner'
...
import type { LocalNfoAnchor } from '@library/nfo/localNfoTypes'
...
export async function resolvePendingResourceIdentity(
  ...
  const nfoService = options.nfoService ?? getConfiguredLocalNfoScanService()
