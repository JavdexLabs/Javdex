...
console.log('library currently owns catalog db, image store, scan helpers/orchestration, NFO, maintenance gate, and path cleanup; Electron NFO export/catalog services remain in desktop. server/http are reserved. This check does not claim a runnable server.')
