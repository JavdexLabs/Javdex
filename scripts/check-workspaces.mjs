...
console.log('library currently owns catalog db, image store, scan helpers, local root file guard, NFO codec/export projection, and sidecar tickets; scanner orchestration/Electron NFO export/services remain in desktop. server/http are reserved. This check does not claim a runnable server.')
