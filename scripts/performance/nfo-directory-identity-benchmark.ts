...
import { normalizeVideoCode } from '../../src/shared/videoCode'
import { sameLogicalCode } from '../../src/main/nfo/nfoSidecarLocator'
...
it('measures one directory identity build and one eligibility check per anchor', async () => {
  const summaryModule = process.env.JAVDEX_NFO_SUMMARY_PROBE === '1'
    ? await import('../../src/main/nfo/directoryVideoIdentity') : null
