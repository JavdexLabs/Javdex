...
const sourcePath = 'src/renderer/src/components/agentMetadata/AgentMetadataCollectorContext.tsx'
const cssPath = 'src/renderer/src/components/agentMetadata/AgentMetadataCollectorContext.module.css'
